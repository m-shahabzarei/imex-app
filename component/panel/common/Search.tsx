...
function Search({ variant, text }: ISearch) {
  if (variant == "primary") {
    ...
    return (
      <input
        className="bg-[rgba(255,255,255,0.06)] border-1 text-[#717171] border-[#E3E3E3] px-10 py-4 w-full rounded-2xl placeholder:text-[#717171] placeholder:opacity-60 focus:outline-0 placeholder:text-xs"
        placeholder={text}
        type="text"
      />
    );
